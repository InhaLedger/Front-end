...
class RecordActivity : AppCompatActivity() {
    ...
    private fun startPlaying() {
        try {
            ...
            val pitchDetectionHandler =
                PitchDetectionHandler { res, e ->
                    val pitchInHz = res.pitch
                    runOnUiThread(Runnable { pitchToNote(pitchInHz) })
                }
            val pitchProcessor: AudioProcessor = PitchProcessor(
                PitchProcessor.PitchEstimationAlgorithm.FFT_YIN,
                22050F,
    ...
    private fun pitchToNote(pitchInHz : Float){
        ...
        if(pitchInHz in 130.80..146.82) {
            //1옥 도
            octaveText.text = "1옥타브"
            noteText.text = "도"
            maxNote = "1옥타브 도"
        }
        else if(pitchInHz in 146.83..164.80) {
            //1옥 레
            octaveText.text = "1옥타브"
            noteText.text = "레"
            maxNote = "1옥타브 레"
        }
        else if(pitchInHz in 164.81..174.60) {
            //1옥 미
            octaveText.text = "1옥타브"
            noteText.text = "미"
            maxNote = "1옥타브 미"
        }
        else if(pitchInHz in 174.61..195.99) {
            //1옥 파
            octaveText.text = "1옥타브"
            noteText.text = "파"
            maxNote = "1옥타브 파"
        }
        else if(pitchInHz in 196.00..219.99) {
            //1옥 솔
            octaveText.text = "1옥타브"
            noteText.text = "솔"
            maxNote = "1옥타브 솔"
        }
        else if(pitchInHz in 220.00..246.93) {
            //1옥 라
            octaveText.text = "1옥타브"
            noteText.text = "라"
            maxNote = "1옥타브 라"
        }
        else if(pitchInHz in 246.94..261.62) {
            //1옥 시
            octaveText.text = "1옥타브"
            noteText.text = "시"
            maxNote = "1옥타브 시"
        }
        else if(pitchInHz in 261.63..293.65) {
            //2옥 도
        ...
        else if(pitchInHz in 293.66..329.62) {
            //2옥 레
            octaveText.text = "2옥타브"
            noteText.text = "레"
            maxNote = "2옥타브 레"
        }
        else if(pitchInHz in 329.63..349.22) {
            //2옥 미
            octaveText.text = "2옥타브"
            noteText.text = "미"
            maxNote = "2옥타브 미"
        }
        else if(pitchInHz in 349.23..391.99) {
            //2옥 파
            octaveText.text = "2옥타브"
            noteText.text = "파"
            maxNote = "2옥타브 파"
        }
        else if(pitchInHz in 392.00..439.99) {
            //2옥 솔
            octaveText.text = "2옥타브"
            noteText.text = "솔"
            maxNote = "2옥타브 솔"
        }
        else if(pitchInHz in 440.00..493.87) {
            //2옥 라
            octaveText.text = "2옥타브"
            noteText.text = "라"
            maxNote = "2옥타브 라"
        }
        else if(pitchInHz in 493.88..523.24) {
            //2옥 시
            octaveText.text = "2옥타브"
            noteText.text = "시"
            maxNote = "2옥타브 시"
        }
        else if(pitchInHz in 523.25..587.32) {
            //3옥 도
            octaveText.text = "3옥타브"
            noteText.text = "도"
            maxNote = "3옥타브 도"
        }
        else if(pitchInHz in 587.33..659.25) {
            //3옥 레
            octaveText.text = "3옥타브"
            noteText.text = "레"
            maxNote = "3옥타브 레"
        }
        else if(pitchInHz in 659.26..698.45) {
            //3옥 미
            octaveText.text = "3옥타브"
            noteText.text = "미"
            maxNote = "3옥타브 미"
        }
        else if(pitchInHz in 698.46..783.98) {
            //3옥 파
            octaveText.text = "3옥타브"
            noteText.text = "파"
            maxNote = "3옥타브 파"
        }
        else if(pitchInHz in 783.99..879.99) {
            //3옥 솔
            octaveText.text = "3옥타브"
            noteText.text = "솔"
            maxNote = "3옥타브 솔"
        }
        else if(pitchInHz in 880.00..987.76) {
            //3옥 라
            octaveText.text = "3옥타브"
            noteText.text = "라"
            maxNote = "3옥타브 라"
        }
        else if(pitchInHz in 987.77..1046.49) {
            //3옥 시
            octaveText.text = "3옥타브"
            noteText.text = "시"
            maxNote = "3옥타브 시"
        }
        else if(pitchInHz in 1046.50..1108.72) {
            //4옥 도
